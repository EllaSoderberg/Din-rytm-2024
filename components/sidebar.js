...
export const Sidebar = props => {
  return (
    <div>
      ...
      >
        <div
          className="h-6 w-6 m-4 float-right fill-white hover:cursor-pointer hover:text-green-100"
      ...
      <div
        ...
        } absolute top-0 left-0 w-screen h-screen bg-black opacity-25`}
        onClick={props.toggleExpansion}
      ></div>
    </div>
  );
